...
public class ChargerSequenceGeneratorService {
	...
	public int getSequenceNumber(String sequenceName) {
		...
		ChargerDbSequence counter = mongoOperations.findAndModify(query, update, options().returnNew(true).upsert(true),
	...
	public String idGenerator() {
		...
		int num = getSequenceNumber(ChargerDto.SEQUENCE_NAME);
		if (num >= 1 && num <= 9)
		...
		return "CHR" + dateFormat.format(dNow) + numberData;
