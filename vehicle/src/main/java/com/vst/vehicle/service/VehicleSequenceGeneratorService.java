...
import com.vst.vehicle.dto.VehicleDbSequence;
import com.vst.vehicle.dto.VehicleDto;

@Service
public class VehicleSequenceGeneratorService {
	 ...
	 public int getSequenceNumber(String sequenceName) {
		 ...
		 VehicleDbSequence counter = mongoOperations
	                .findAndModify(query,
	                        update, options().returnNew(true).upsert(true),
	                        VehicleDbSequence.class);
	 ...
	 public String idGenerator() {
			...
			int num = getSequenceNumber(VehicleDto.SEQUENCE_NAME);
			if (num >= 1 && num <= 9)
			...
			return "VHL" + dateFormat.format(dNow) + numberData;
	 }
